...
**List Methods and Built - In Functions**<br>
| **Method**       | **Description**                                                                 | **Example**                                                                                                                                                                         |
|------------------|----------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `len()`          | Returns the length (number of elements) of the list.                            | `python >>> list1 = [10, 20, 30, 40, 50] >>> len(list1) # 5`                                                                                                                        |
| `list()`         | Creates an empty list if no argument is passed; creates a list from a sequence. | `python >>> list1 = list() >>> list1 # [] >>> str1 = 'aeiou' >>> list2 = list(str1) >>> list2 # ['a', 'e', 'i', 'o', 'u']`                                                          |
| `append()`       | Appends a single element (can be a list) at the end of the list.                | `python >>> list1 = [10, 20, 30, 40] >>> list1.append(50) >>> list1 # [10, 20, 30, 40, 50] >>> list1.append([60, 70]) >>> list1 # [10, 20, 30, 40, 50, [60, 70]]`                     |
| `extend()`       | Appends each element of the iterable to the end of the list.                    | `python >>> list1 = [10, 20, 30] >>> list2 = [40, 50] >>> list1.extend(list2) >>> list1 # [10, 20, 30, 40, 50]`                                                                     |
| `insert()`       | Inserts an element at a specified index in the list.                            | `python >>> list1 = [10, 20, 30, 40, 50] >>> list1.insert(2, 25) >>> list1 # [10, 20, 25, 30, 40, 50] >>> list1.insert(0, 5) >>> list1 # [5, 10, 20, 25, 30, 40, 50]`                |
| `count()`        | Returns the number of times a specified element appears in the list.            | `python >>> list1 = [10, 20, 30, 10, 40, 10] >>> list1.count(10) # 3 >>> list1.count(90) # 0`                                                                                       |
| `index()`        | Returns the index of the first occurrence of the element. Raises ValueError if not found. | `python >>> list1 = [10, 20, 30, 20, 40, 10] >>> list1.index(20) # 1 >>> list1.index(90) # ValueError: 90 is not in list`                                                 |
| `remove()`       | Removes the first occurrence of the element. Raises ValueError if not found.    | `python >>> list1 = [10, 20, 30, 40, 50, 30] >>> list1.remove(30) >>> list1 # [10, 20, 40, 50, 30] >>> list1.remove(90) # ValueError: list.remove(x): x not in list`                |
| `pop()`          | Removes and returns the element at the given index. Defaults to last element.   | `python >>> list1 = [10, 20, 30, 40, 50, 60] >>> list1.pop(3) # 40 >>> list1 # [10, 20, 30, 50, 60] >>> list1.pop() # 60 >>> list1 # [10, 20, 30, 50]`                              |
| `reverse()`      | Reverses the order of the list in place.                                        | `python >>> list1 = [34, 66, 12, 89, 28, 99] >>> list1.reverse() >>> list1 # [99, 28, 89, 12, 66, 34]`                                                                             |
| `sort()`         | Sorts the list in place. Use `reverse=True` for descending order.               | `python >>> list1 = [34, 66, 12, 89, 28, 99] >>> list1.sort() >>> list1 # [12, 28, 34, 66, 89, 99] >>> list1.sort(reverse=True) >>> list1 # [99, 89, 66, 34, 28, 12]`                |
| `sorted()`       | Returns a new sorted list from the iterable.                                    | `python >>> list1 = [23, 45, 11, 67, 85, 56] >>> list2 = sorted(list1) >>> list1 # [23, 45, 11, 67, 85, 56] >>> list2 # [11, 23, 45, 56, 67, 85]`                                  |
| `min()`          | Returns the smallest element in the list.                                       | `python >>> list1 = [34, 12, 63, 39, 92, 44] >>> min(list1) # 12`                                                                                                                  |
| `max()`          | Returns the largest element in the list.                                        | `python >>> list1 = [34, 12, 63, 39, 92, 44] >>> max(list1) # 92`                                                                                                                  |
| `sum()`          | Returns the sum of all elements in the list.                                    | `python >>> list1 = [34, 12, 63, 39, 92, 44] >>> sum(list1) # 284`                                                                                                                 |
